...
module.exports = initQuestions = async () => {
  ...
  printMessage(
    [
      ...
      "https://docs.sudobox.io/Get%20Started/Installation/CLI/",
      "",
    ],
    {
      border: false,
  ...
  const answers = await inquirer.prompt([
    ...
    },
    {
      ...
      default: configFile && configFile?.domain !== "" && true,
      when: (answers) => {
        return answers.storage === "Cloud";
      },
    },
  ...
  printMessage(
    [
      ...
      "https://docs.sudobox.io/single-sign-on",
      "",
      "NOTE: We will be asking you to enter passwords for various applications needed to run Authelia",
      "We will generate unique ones for you, However, You can overide them if you wish to, but we recommend you stick with the defaults.",
      "",
    ],
    {
      border: false,
  ...
  console.log("");
  console.log("Authelia Password: " + passwordsHash.auth_password);
