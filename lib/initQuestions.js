...
module.exports = initQuestions = async () => {
  ...
  printMessage(
    [
      ...
      "Great open source project go and check them out here https://www.authelia.com/",
      "For networking we will be utilising Traefik (pronounced traffic) https://traefik.io/",
      "For step by step guides please go to:",
      "https://blahblahblah/",
      "",
      "We will be asking you to enter passwords for the various applications needed to run",
      "We will generate unique ones for you. You can overide them, but we recommend you stick with the defaults.",
      "",
    ],
    {
      border: false,
